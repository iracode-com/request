 ...
 * @property Form $form
 */
class CustomResetPasswordReset extends SimplePage
{
            ...
            ->rules([
                function () {
                    return function (string $attribute, $value, \Closure $fail) {
                        $expectedCode = (string)Cache::get('reset_pass_' . $this->email);

                        if ($expectedCode !== $value) {
                            $fail(__('The verification code is invalid or has expired.'));
                        }
                    };
                },
            ])
