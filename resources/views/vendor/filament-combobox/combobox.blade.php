...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div class="flex flex-col gap-2" x-ignore ax-load
        ...
        @endif
        <div class="flex w-full min-h-36" style="height: {{ $height }}">
            ...
            <div class="flex flex-col items-center justify-center w-20 gap-1 p-2">
                <x-filament-combobox::button :icon="'heroicon-s-chevron-left'" :disabled="$isDisabled()" :action="'moveToRight'" />
                <x-filament-combobox::button :icon="'heroicon-s-chevron-double-left'" :disabled="$isDisabled()" :action="'moveToRightAll'" />
                <x-filament-combobox::button :icon="'heroicon-s-chevron-right'" :disabled="$isDisabled()" :action="'moveToLeft'" />
                <x-filament-combobox::button :icon="'heroicon-s-chevron-double-right'" :disabled="$isDisabled()" :action="'moveToLeftAll'" />
            </div>
            <div class="w-1/2 h-full">
